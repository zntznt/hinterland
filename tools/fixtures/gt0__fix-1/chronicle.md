...
The works at Forby turned aetherstone to lumen, and the trunk lines ran from their yards to the seat. The Temple kept holy ground at Jessanth (by Valgremmorn Tor) — out where the sacred substance lies and the Crown's writ runs thin. Every settlement of the realm sat on the conduit at the founding — a generosity of the ledgers the chronicle does not expect to last.
...
The old world is not gone: the delve called Volvar gapes in the old workings by Valgremmorn Tor, the tomb of Marisanthe keeps its silence in the barrens by Glarhold and the delve called Murnhak gapes in the old workings by Korgar. Delvers walk the Forby road every season, because risk is a wage where nothing else pays one; not all of them walk back, and what they carry out is sold in no sanctioned market.
...
Where the beasts are worth a bounty and the garrisons never come, hunters keep Grek Camp by Linden. The stands thin the predation on their ground, the trophies are fenced where nothing is taxed, and for the poorest the bounty is the one rung of a ladder the realm never built.
...
The chronicle divides these years into ages, named for what the realm was living through: **the Age of the Gates** (1000–1025), when the gap narrowed, **the Long Desolation** (1050–1100), when the gap widened and **the Age of the Gates** (1125–1250), when the gap narrowed. The names are not decreed; they are read from the record — from where the wealth concentrated, the gates tolled, the towns emptied or came back.
...
**Year 1175.** The god's fortune rose at Linden, and with it the town's. Pilgrims rerouted, coin followed the pilgrims, and the temple that had gone quiet was affluent again. The faithful keep the year as the Rise of Linden.
...
**Year 1200.** The rains failed over Carise, and failed again. The wells that were shared were shared no longer; the country the water had barely reached went to dust first. The scribes head the dry page the Drought of 1200.
...
**Year 1225.** A storm came off the water and stood over the coast for three days. Korgar took the worst of it, as the exposed shore always does; the Great Storm of 1225 is the name the survivors gave the year.
...
**Year 1225.** The god's fortune rose at Linden, and with it the town's. Pilgrims rerouted, coin followed the pilgrims, and the temple that had gone quiet was affluent again. The faithful keep the year as the Rise of Linden.
...
The chronicle closes its count of the years with the names they left behind. The realm now speaks of Korgar the Hollow, Dunholdham the Ashen, Glarhold the Ashen, Hallford the Hollow, Umbere the Ashen, Forby the Gilded, Linden the Ashen, Strakketh the Ashen, Astehold the Ashen, Valgremmorn Tor the Hollow, Carise the Hollow and Varvek the Hollow — bynames no charter granted and no decree can take away, which is why they are the truest record in this document.

## The State of the Realm — year 1250

Of the realm's 3 settled regions, 2 declined and 1 collapsed outright.
9 holdings stand empty now — the deadholds, where a town was and is not. The maps still name Korgar, Dunholdham, Glarhold and Hallford among others; the roads have stopped going.
And 1 place has come back as something else — Varvek stand again on ground that had been left for dead, under names in a different tongue than the one they carried before.

The Crown holds 5 regions, the Temple 2, the magnates 0; 2 are contested between them, and 3 answer to no one at all.

Of the realm's 4 gates — the bridges, the passes, the quays — the Crown keeps 1, the Temple 1, and the magnates 0; 2 stand untolled. Every levy on the list is paid by people who did not choose the road.
...
And in every town the record counts two peoples under one name: the owners' row and the labor it hires. Taken together, 6.9 in every hundred of the realm's people hold 77 of every hundred coins, and live 45.2 times better than those who work for them. Nowhere is the ledger sharper than at Forby, where 83 coins in the hundred belong to the few; a map of regions, which knows towns but not rows, misses 79 parts in a hundred of the whole spread.
...
The chronicler is required to close with what the numbers say, and the numbers say this. This world closed some of its gap: the spread of fortunes measured 0.29 at the founding and 0.24 at the close, and the turning point was the Crown Granary of 1100. The poorest fifth of the realm carries 0.8 times the blight of the richest fifth. 0 regions sit off the conduit because the ledgers said serving them would not pay. Linden drinks 32 points of other towns' poison for the crime of standing at the mouth. 3 regions pay tolls at gates whose holders they never chose. And within every wall the shares were already set: 6.9 in a hundred hold 77 of every hundred coins, and stand 45.2 times apart from the rest. The skyway would abolish 29.1 parts in a hundred of the walled country's distance to the seat, and the walled country's labor may not board it. The Zharrok divides even the weather: the rain falls at 37 on one side and 29 in its lee, and no one on the dry side chose the wind. And Varvek and Glarhold stand the same distance from the seat, one in the open and one behind the wall; the record shows which one prospered, and the mountain is the whole of the explanation.
