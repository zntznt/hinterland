...
There is also the Eldhartholt Lane: lift-barges running between Brook and Cerandre Cairn, over the walls, fords, and gates below. The lanes go where the ground is hardest and the cargo most valuable, and you pay to board at the aerie. The road is open to everyone; the sky isn't.
...
The Crack Beck runs down from the high ground by Brokford through 3 regions to the border. The towns drink from it in order: Brokford gets it clean; Serrok, at the mouth, gets whatever every town and aetherworks upstream have dumped in. Nobody at the mouth chose to be last. The land decided that.
...
Where the beasts are worth a bounty and the constabularies never come, hunters keep Krak Camp by Corineby. The stands thin the predation on their ground, the trophies are fenced where nothing is taxed, and for the poorest the bounty is the one rung of a ladder the realm never built.

The rivers are crossed at Serrok Bridge alone; everywhere else the banks are marsh and the water must be forded, and the fords are where the wagons drown. Whoever holds a bridge holds a queue of people who cannot go around.
...
**Year 1025.** Fever ran through Corineby. The blight had weakened the town for a generation, and the sick had nowhere clean to lie. The burial rolls ran longer than the tax rolls that year. The roads named it the Ash Fever of 1025.
...
**Year 1050.** Plague took Serrok. The blight had sat heavy on that country for years, so the sickness arrived to a town already half-poisoned. A third of the people died or fled. The roads named it the Downstream Flux of 1050.
...
**Year 1075.** The Temple came to Corineby, to the ground of its suffering, and consecrated it as Lowenne. Pilgrims walk that road now. The Crown's writ had failed there and the magnates' ledgers had seen nothing worth the ink. The faith moved in after the harm was done, and claimed the ground.
...
**Year 1175.** The god's fortune rose at Cerandre Cairn, and with it the town's. Pilgrims rerouted, coin followed the pilgrims, and the temple that had gone quiet was affluent again. The faithful keep the year as the Rise of Cerandre Cairn.
...
**Year 1225.** The god's fortune rose at Cerandre Cairn, and with it the town's. Pilgrims rerouted, coin followed the pilgrims, and the temple that had gone quiet was affluent again. The faithful keep the year as the Rise of Cerandre Cairn.
...
The years leave names behind them. The realm now speaks of Drakby the Hollow, Umbereton the Famished, Nockhold the Hollow, Brokford the Hollow, Umberthold the Hollow, Brook the Steadfast, Serrok the Hollow, Dhozzurn the Hollow, Biregard the Hollow, Cerandre Cairn the Hollow, Corineby the Hollow and Brathby the Hollow: bynames no charter granted and no decree can take away. They are the plainest record in this document, because the people kept them on their own.
...
And every town holds two peoples under one name: the owners' row and the labor it hires. Together, 5.7 in every hundred of the realm's people hold 43.9 of every hundred coins, and live 12.9 times better than the people who work for them. The gap is sharpest at Brook, where 46 coins in every hundred belong to the few. A map drawn by region cannot show this, since it sees towns but not rows, and it misses 95 parts in a hundred of the whole spread.
