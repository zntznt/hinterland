...
These years split into ages, each named for what the realm was living through: **the Age of the Gates** (1000–1050), when the gap held, **the Age of Tariffs** (1075–1150), when the gap narrowed and **the Age of Tariffs** (1175–1250), when the gap narrowed. No one decreed the names. They come from the record itself: where the wealth piled up, where the gates charged tariffs, and where the towns emptied out or came back.
