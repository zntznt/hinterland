...
The chronicle divides these years into ages, named for what the realm was living through: **the Quiet Years** (1000–1050), when the gap narrowed, **the Quiet Years** (1075–1100), when the gap held, **the Restoration** (1125–1150), when the gap narrowed and **the Age of the Gates** (1175–1250), when the gap widened. The names are not decreed; they are read from the record — from where the wealth concentrated, the gates tolled, the towns emptied or came back.
