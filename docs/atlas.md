...
distinct classes** appear and the most common holds only **19%**.
...
*the Dominion's deepest hold of the sweep.* In the reign of ?: wealth gini 0.56, 13% off-grid, 0 wars, 2 seizures, 1 succession crisis, max abandonment 38.
...
*the narrowest wealth gap. Note what it still fails to level.* In the reign of ?: wealth gini 0.28, 13% off-grid, 0 wars, 0 seizures, 1 succession crisis, max abandonment 40.
...
*the heaviest downstream blight.* In the reign of ?: wealth gini 0.50, 21% off-grid, 1 war, 10 seizures, 0 succession crises, max abandonment 36.
...
[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-77&regions=24&ep=10)
...
*courted, developed, then let go when the lode ran thin. Ruin and freedom in one year.* In the reign of ?: wealth gini 0.62, 29% off-grid, 0 wars, 2 seizures, 3 succession crises, max abandonment 46.
