...
Where the beasts are worth a bounty and the constabularies never come, hunters keep Trek Camp by Cerandre Cairn. The stands thin the predation on their ground, the trophies are fenced where nothing is taxed, and for the poorest the bounty is the one rung of a ladder the realm never built.
...
These years split into ages, each named for what the realm was living through: **the Age of the Gates** (1000–1050), when the gap widened, **the Age of Tariffs** (1075–1125), when the gap narrowed, **the Hollow Years** (1150–1200), when the gap narrowed and **the Gathering Years** (1225–1250), when the gap narrowed. No one decreed the names. They come from the record itself: where the wealth piled up, where the gates charged tariffs, and where the towns emptied out or came back.
...
**Year 1075.** The magnates pulled their money out of Brook when the ore stopped paying. The aetherworks went dark, and the town it had grown around emptied behind it.
...
**Year 1125.** The magnates pressed their claim on the crossing at Drakby. No blood is recorded. The claim was made on paper, and the tariff kept it.

**Year 1150.** Plague took Vrakton. The blight had sat heavy on that country for years, so the sickness arrived to a town already half-poisoned. A third of the people died or fled. The roads named it the Grey Breath of 1150.

**Year 1150.** Vrakton rose. The constabulary line broke and the mob held. Vrakton keeps what it makes now, and its gates charge no one. But freedom is not food. The magnates' capital left with the magnates, the aetherworks it had funded went dark, and the skilled workers followed the money out. The free town starved. The injustice had been real and so was the freedom, and neither one fed anyone. The people keep the date as the Vrakton Rising.
...
**Year 1225.** The rains failed over Cerandre Cairn, and failed again. Wells that had been shared were closed off, and the country the water had barely reached went to dust first. The scribes titled the dry page the Drought of 1225.
...
The years leave names behind them. The realm now speaks of Drakby the Hollow, Vrakton the Famished, Brokhold the Shadowed, Brokford the Shadowed, Umberthold the Hollow, Brook the Steadfast, Dhozzurn the Hollow, Krukgard the Shadowed, Cerandre Cairn the Hollow, Gordness the Lofted and Mallby the Steadfast: bynames no charter granted and no decree can take away. They are the plainest record in this document, because the people kept them on their own.

## The State of the Realm, Year 1250

Of the realm's 9 settled regions, 4 held steady, 3 declined and 2 collapsed outright.
3 holdings stand empty now. These are the deadholds, places where a town once stood and no longer does. The maps still name Drakby, Vrakton and Umberthold, but the roads have stopped going there.
And 2 places have come back as something else. Dhozzurn and Cerandre Cairn stand again on ground that had been left for dead, under names in a different tongue than the one they carried before.
...
The Crown holds 7 regions, the Temple 1, the magnates 1; 0 are contested between them, and 3 answer to no one at all.
...
And every town holds two peoples under one name: the owners' row and the labor it hires. Together, 3.8 in every hundred of the realm's people hold 36.3 of every hundred coins, and live 14.3 times better than the people who work for them. The gap is sharpest at Brook, where 51 coins in every hundred belong to the few. A map drawn by region cannot show this, since it sees towns but not rows, and it misses 49 parts in a hundred of the whole spread.
...
The record closes with what the numbers say. This world held its shape. The wealth gap stayed at 0.26. It turned on the rising at Vrakton in 1150, which won its freedom and then starved. The realm's poorest fifth of towns carries 6.6 times the blight of its richest fifth. 2 regions sit off the grid because the ledgers said serving them would not pay. Merelmere drinks 12 points of other towns' poison, only because it stands at the mouth. 9 regions pay tariffs at gates whose holders they never chose. And inside every town, the shares were set from the start: 3.8 in a hundred hold 36.3 of every hundred coins, and live 14.3 times better than the rest. The skyway would cut 38.8 parts in a hundred off the walled country's distance to the capital, but the walled country's labor is not allowed to board it. The empire mostly did not invade. It bought in. 1 coast is a foreign concession, richer than the realm's median at 0 against 14, and owning barely half of it: 50 in the hundred of the yield is entered in the Aurean League's books, not the realm's. The Zolzek divides even the weather: the rain falls at 37 on one side and 29 in its lee, and no one on the dry side chose the wind. And Mallby and Brokhold stand the same distance from the capital, one in the open and one behind the wall. The record shows which one prospered, and the mountain is the only thing that separates them.
