...
|---|---|---|---|
| wealth gini (between places) | 0.33 | 0.51 | 0.71 |
| gini drift (close − founding) | -0.19 | -0.02 | 0.14 |
| within-place share of person inequality % | 25 | 53 | 93 |
| owners' rows' share of all coin % | 31.70 | 46.90 | 85.90 |
| rank-size alpha (Zipf ≈ 1) | 1.23 | 2.31 | 2.87 |
| urban primacy (1st/2nd) | 1 | 1.60 | 41.30 |
| sky advantage behind the wall (mean) | 0 | 41.60 | 73 |
| off-grid share | 0.04 | 0.25 | 0.88 |
| mountain-shadow share | 0.04 | 0.29 | 0.83 |
| corr(blight, wealth) | -0.39 | -0.12 | 0.31 |
...
distinct classes** appear and the most common holds only **23%** —
the §7.3 diversity floor (≥6 classes, none over 40%) is met.

| verdict class | worlds |
|---|---|
| quiet decay · collapse | 18 |
| shared rise · collapse | 10 |
| extraction · collapse | 8 |
| quiet decay · boom | 6 |
| leveling down · collapse | 6 |
| shared rise · boom | 6 |
| shared rise · stagnant | 5 |
| quiet decay · stagnant | 5 |
| extraction · boom | 5 |
| quiet growth · boom | 4 |
| leveling down · stagnant | 3 |
| quiet growth · stagnant | 2 |
| quiet growth · collapse | 1 |
| leveling down · boom | 1 |

## The atlas

### The World That Closed Its Gap — the realm of Denbriar
...
### The Entrenched World — the realm of Sorby
...
### The Company Country — the realm of Rukkethak

*the world a region map lies about most: its inequality lives INSIDE the walls.* In the reign of Sorrook: wealth gini 0.51, 29% off-grid, 1 war, 9 seizures, 3 succession crises, max abandonment 73.

> And in every town the record counts two peoples under one name: the owners' row and the labor it hires. Taken together, 7.6 in every hundred of the realm's people hold 77.3 of every hundred coins, and live 41.4 times better than those who work for them. Nowhere is the ledger sharper than at Rukkethak Delf, where 79 coins in the hundred belong to the few; a map of regions, which knows towns but not rows, misses 93 parts in a hundred of the whole spread.

[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-27&regions=24&ep=10)
...
### The Primate City — the realm of Vannor

*one town swallowed the centuries.* In the reign of Alewick: wealth gini 0.61, 29% off-grid, 1 war, 9 seizures, 1 succession crisis, max abandonment 39.

> No charter drew the towns to size. The centuries did: good land compounded, the fairs drew the valleys in, and by year 1000 the largest town held 18,353 souls to the median town's 2,121 — a hierarchy grown, not granted, and steeper every century the compounding ran.

[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-48&regions=24&ep=10)

### The Ledger's Realm — the realm of Gromvarn
...
### The Unequal Country — the realm of Merbrow
...
### The Level Country — the realm of Fenholt

*the narrowest wealth gap — note what it still fails to level.* In the reign of Ulven: wealth gini 0.33, 21% off-grid, 1 war, 2 seizures, 4 succession crises, max abandonment 38.

> Of the realm's 4 gates — the bridges, the passes, the quays — the Crown keeps 4, the Temple 0, and the magnates 0; 0 stand untolled. Every levy on the list is paid by people who did not choose the road.

[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-4&regions=24&ep=10)

### The Dark Realm — the realm of Dunhorth
...
### The Walled Realm — the realm of Vannor

*the most mountain-shadowed world.* In the reign of Alewick: wealth gini 0.61, 29% off-grid, 1 war, 9 seizures, 1 succession crisis, max abandonment 39.

> (this world keeps its counsel)

[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-48&regions=24&ep=10)

### The Burning Years — the realm of Dovrak
...
### The Quiet Years — the realm of Nether

*the calmest history — the founding order simply compounded.* In the reign of Briar: wealth gini 0.49, 4% off-grid, 1 war, 0 seizures, 0 succession crises, max abandonment 55.

> The chronicle records no upheavals.

[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-42&regions=24&ep=10)

### The Poisoned Mouth — the realm of Wellowmere
...
### The Ghost Country — the realm of Denbriar

*the deepest abandonment scar.* In the reign of Sorselsden: wealth gini 0.53, 21% off-grid, 1 war, 9 seizures, 2 succession crises, max abandonment 75.

> Stroth is the emptiest of the ghost country: its best years are a memory the roads no longer visit.
...
> Of the realm's 7 gates — the bridges, the passes, the quays — the Crown keeps 3, the Temple 0, and the magnates 0; 0 stand untolled. Every levy on the list is paid by people who did not choose the road.

[Open this world](https://zntznt.github.io/hinterland/#seed=atlas-47&regions=24&ep=10)

### The Town That Freed Itself — the realm of Harrifolt
...
### The Concession Coast — the realm of Dovrak
...
### The Abandoned Coast — the realm of Derbrow
