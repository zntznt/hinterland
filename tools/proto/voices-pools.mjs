...
export const ORAL = {
  ...
  open: [
    ...
    { t: "I keep no ledger in {town}, so I'll tell it straight", req: any },
  ...
  elsewhere: [
    ...
    { t: "there are more of {town} gone than left, and that is a true count", req: c => c.emig >= 0.15 * c.pop },
  ...
  closer: [
    { t: "that is the whole of it, and you may walk {town} and check it yourself", req: any },
    { t: "write {town} down if you're writing anything", req: any },
    ...
    { t: "you'll not get that from {blamed}, but you have it from me", req: any },
    { t: "come back to {town} in ten years and see which of us was right", req: any },
    { t: "that is not a complaint about {town}, it is a measurement", req: any, band: notpos },
