...
The aetherworks at Brook refine aetherstone into lumen, and the trunk lines run from them to the capital. The Temple holds sacred ground at Galcyonne (by Cerandre Cairn), out where the aetherstone lies and the Crown's authority is weak. Every settlement started on the grid. The ledgers rarely allow that, and never for long.
...
These years split into ages, each named for what the realm was living through: **the Age of the Gates** (1000–1050), when the gap held, **the Age of Tariffs** (1075–1125), when the gap narrowed, **the Hollow Years** (1150–1200), when the gap narrowed and **the Age of the Crossings** (1225–1250), when the gap held. No one decreed the names. They come from the record itself: where the wealth piled up, where the gates charged tariffs, and where the towns emptied out or came back.
...
**Year 1150.** Vrakton rose, and was put down. The constabulary arrived after the hangings. The injustice that caused the rising was written down in full and then left alone. The people keep the date as the Vrakton Rising.
