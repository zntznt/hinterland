...
Where the beasts are worth a bounty and the garrisons never come, hunters keep Tash Camp by High Lorvasonne. The stands thin the predation on their ground, the trophies are fenced where nothing is taxed, and for the poorest the bounty is the one rung of a ladder the realm never built.
...
And in every town the record counts two peoples under one name: the owners' row and the labor it hires. Taken together, 5.1 in every hundred of the realm's people hold 46.7 of every hundred coins, and live 16.2 times better than those who work for them. Nowhere is the ledger sharper than at High Lorvasonne, where 77 coins in the hundred belong to the few; a map of regions, which knows towns but not rows, misses 55 parts in a hundred of the whole spread.
...
The chronicler is required to close with what the numbers say, and the numbers say this. This world entrenched: the spread of fortunes measured 0.35 at the founding and 0.51 at the close, and the turning point was the rising at Zoltgard in 1100, which won. The poorest fifth of the realm carries 1.4 times the blight of the richest fifth. Behind the Skallorvek wall, the median settlement earns 100 in the hundred less than the open country at the same remove. 5 regions sit off the conduit because the ledgers said serving them would not pay, and sickness runs 1.2 times heavier there than in the lit core. Glare drinks 9 points of other towns' poison for the crime of standing at the mouth. 6 regions pay tolls at gates whose holders they never chose. And within every wall the shares were already set: 5.1 in a hundred hold 46.7 of every hundred coins, and stand 16.2 times apart from the rest. The skyway would abolish 54 parts in a hundred of the walled country's distance to the seat, and the walled country's labor may not board it. And the realm's own ledger is a column in someone else's: 4 regions occupied, the yield assessed at the quay, the free country keeping 1.8 times the share the occupied country keeps — sovereignty was the last inequality, and it ordered all the others. And Glare and Bellok stand the same distance from the seat, one in the open and one behind the wall; the record shows which one prospered, and the mountain is the whole of the explanation.
