...
These years split into ages, each named for what the realm was living through: **the Age of the Gates** (1000–1050), when the gap narrowed, **the Age of Tariffs** (1075–1100), when the gap held, **the Still Years** (1125–1200), when the gap held and **the Gathering Years** (1225–1250), when the gap held. No one decreed the names. They come from the record itself: where the wealth piled up, where the gates charged tariffs, and where the towns emptied out or came back.
