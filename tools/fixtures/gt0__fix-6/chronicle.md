...
The chronicle divides these years into ages, named for what the realm was living through: **the Age of the Gates** (1000–1125), when the gap narrowed, **the Restoration** (1150–1200), when the gap narrowed and **the Age of Accumulation** (1225–1250), when the gap widened. The names are not decreed; they are read from the record — from where the wealth concentrated, the gates tolled, the towns emptied or came back.
