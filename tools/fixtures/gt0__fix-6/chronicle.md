...
The aetherworks at Asellby refine aetherstone into lumen, and the trunk lines run from them to the capital. The Temple holds sacred ground at Delle (by Halle Crag), out where the aetherstone lies and the Crown's authority is weak. Every settlement started on the grid. The ledgers rarely allow that, and never for long.

There is also the Merell Lane: lift-barges running between Halle Crag and Asellby, over the walls, fords, and gates below. The lanes go where the ground is hardest and the cargo most valuable, and you pay to board at the aerie. The road is open to everyone; the sky isn't.
...
The Briar Rill runs down from the high ground by Halle Crag through 2 regions to the border. The towns drink from it in order: Halle Crag gets it clean; Ramwill Reach, at the mouth, gets whatever every town and aetherworks upstream have dumped in. Nobody at the mouth chose to be last. The land decided that.
...
The rivers are crossed at Ramwill Reach Bridge and Halle Crag Bridge; everywhere else the banks are marsh and the water must be forded, and the fords are where the wagons drown. Whoever holds a bridge holds a queue of people who cannot go around.

## The Years

These years split into ages, each named for what the realm was living through: **the Age of the Gates** (1000–1050), when the gap narrowed, **the Age of Tariffs** (1075–1100), when the gap widened, **the Still Years** (1125–1200), when the gap held and **the Gathering Years** (1225–1250), when the gap widened. No one decreed the names. They come from the record itself: where the wealth piled up, where the gates charged tariffs, and where the towns emptied out or came back.
...
**Year 1125.** The magnates pulled their money out of Asellby when the ore stopped paying. The aetherworks went dark, and the town it had grown around emptied behind it.
...
**Year 1175.** The capital chartered aetherworks at Hamwick. The wires reached it fast, because someone had already decided the ore was worth the copper.
...
The years leave names behind them. The realm now speaks of Brakton the Hollow, Halle Crag the Hollow, Khekton the Hollow, Ramwill Reach the Yoked, Glasholt Crag the Free, Asellby the Steadfast, Myreby the Yoked, Serrvarnuk Bastion the Hollow, Hamwick the Yoked, High Gravul the Hollow, Gnokton the Hollow and Calvermere the Yoked: bynames no charter granted and no decree can take away. They are the plainest record in this document, because the people kept them on their own.
...
And 4 places have come back as something else. Brakton, Halle Crag and Myreby stand again on ground that had been left for dead, under names in a different tongue than the one they carried before.
