...
| `value_retention` | region | 0–100 | Share of locally-generated resource value that stays local = f(local refining vs raw extraction, centrality). The core retention ratio. Under a concession (§8, B11), part of it becomes a FOREIGN claim. | EMERGENT |
...
## 5. The original spine (Phases 1–6, historical and complete)
