...
The Briar Rill runs down from the high ground by Dravzek Crag through 2 regions to the border. The towns drink from it in order: Dravzek Crag gets it clean; Drukton, at the mouth, gets whatever every town and aetherworks upstream have dumped in. Nobody at the mouth chose to be last. The land decided that.
...
The old world is still here: the delve called Kalgrek gapes in the old workings by Dravzek Crag, the tomb of Nivelianthe keeps its silence in the barrens by Serrvarnuk Bastion and the delve called Gnakkelkrak gapes in the old workings by Drukton. Delvers work the Drukton road every season, because it pays when nothing else does. Not all of them come back, and what they carry out is sold off the books.
...
The rivers are crossed at Drukton Bridge alone; everywhere else the banks are marsh and the water must be forded, and the fords are where the wagons drown. Whoever holds a bridge holds a queue of people who cannot go around.

## The Years

These years split into ages, each named for what the realm was living through: **the Age of the Gates** (1000–1000), when the gap held, **the Emptying** (1025–1050), when the gap widened, **the Second Spring** (1075–1100), when the gap held, **the Still Years** (1125–1200), when the gap held and **the Gathering Years** (1225–1250), when the gap widened. No one decreed the names. They come from the record itself: where the wealth piled up, where the gates charged tariffs, and where the towns emptied out or came back.
...
**Year 1125.** The aetherworks at Asellby failed. The seam it drew from was mined to nothing, and the wages stopped a season before the wires did.

**Year 1125.** The river rose over Drukton and took the low ground with it: the fields, the founding wharves, whatever stood in the way. The accounts call it the Drukton Flood, and they do not agree on how many it took.
...
**Year 1200.** The river rose over Drukton and took the low ground with it: the fields, the founding wharves, whatever stood in the way. The accounts call it the Drukton Flood, and they do not agree on how many it took.
...
**Year 1250.** The river rose over Drukton and took the low ground with it: the fields, the founding wharves, whatever stood in the way. The accounts call it the Drukton Flood, and they do not agree on how many it took.
...
And 4 places have come back as something else. Brakton, Drukton and Myreby stand again on ground that had been left for dead, under names in a different tongue than the one they carried before.
Drukton is the emptiest of the ghost country. Its best years are gone, and the roads no longer go there.
...
And every town holds two peoples under one name: the owners' row and the labor it hires. Together, 5.3 in every hundred of the realm's people hold 39.9 of every hundred coins, and live 11.7 times better than the people who work for them. The gap is sharpest at Hamwick, where 52 coins in every hundred belong to the few. A map drawn by region cannot show this, since it sees towns but not rows, and it misses 43 parts in a hundred of the whole spread.
...
The record closes with what the numbers say. This world got more unequal. The wealth gap went from 0.28 at the founding to 0.45 at the close. It turned on the Crown Granary in 1075. The poorest fifth of the realm carries 0 times the blight of the richest fifth. Behind the Dhulzar wall, the median settlement earns 100 in the hundred less than the open country at the same distance. 4 regions sit off the grid because the ledgers said serving them would not pay. 6 regions pay tariffs at gates whose holders they never chose. And inside every town, the shares were set from the start: 5.3 in a hundred hold 39.9 of every hundred coins, and live 11.7 times better than the rest. The skyway would cut 54 parts in a hundred off the walled country's distance to the capital, but the walled country's labor is not allowed to board it. And the whole realm's ledger is now one column in someone else's book: 4 regions occupied, the yield assessed at the quay, the free country keeping 1.5 times the share the occupied country keeps. The gap between who is sovereign and who is occupied is the largest one in the realm, and it shapes every other. The empire mostly did not invade. It bought in. 1 coast is a foreign concession, richer than the realm's median at 62 against 14, and owning barely half of it: 50 in the hundred of the yield is entered in the Osmark Combine's books, not the realm's. And Drukton and Khekton stand the same distance from the capital, one in the open and one behind the wall. The record shows which one prospered, and the mountain is the only thing that separates them.
