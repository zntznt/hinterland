...
The chronicle divides these years into ages, named for what the realm was living through: **the Age of the Gates** (1000–1000), when the gap held, **the Long Desolation** (1025–1125), when the gap widened and **the Age of Accumulation** (1150–1250), when the gap widened. The names are not decreed; they are read from the record — from where the wealth concentrated, the gates tolled, the towns emptied or came back.
...
The chronicle closes its count of the years with the names they left behind. The realm now speaks of Vorvek the Hollow, High Lorvasonne the Gilded, Bellok the Hollow, Glare the Yoked, High Kellow the Free, Santhielle the Yoked, Zoltgard the Hollow, Wexbraverby the Yoked, High Kornhak the Hollow, Dharrok the Hollow and Evere the Yoked — bynames no charter granted and no decree can take away, which is why they are the truest record in this document.
