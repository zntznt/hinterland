...
const nRoads = svg ? svg.querySelectorAll("line.road").length : 0;
const nGar = svg ? svg.querySelectorAll("text.gar").length : 0;
const nRidge = svg ? svg.querySelectorAll("polyline.ridge").length : 0;
const nPass = svg ? svg.querySelectorAll("text.pass").length : 0;
const nRiver = svg ? svg.querySelectorAll("polyline.river").length : 0;
